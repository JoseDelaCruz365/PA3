...
# ================================
# GRÁFICO 2: Top N Artículos Más Citados (mayor a menor)
# ================================
...
# 🔧 CAMBIO IMPORTANTE: ordenar de MAYOR a MENOR (el más citado arriba)
...
if not top_articulos.empty:
    ...
    # 🔧 Ya NO invertimos y_pos (porque queremos mayor arriba)
